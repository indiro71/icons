...
function ExportIconSolid({
  ...
  return (
    <svg
      ...
      className="exportIconSolid_svg__svg-inline--fa exportIconSolid_svg__fa-file-export exportIconSolid_svg__fa-w-18"
...
export default ExportIconSolid;
